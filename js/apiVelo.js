var Stations = {
	...
	url : function() {
		return 'https://api.jcdecaux.com/vls/v1/stations?contract=' + Stations.contractName + '&apiKey=' + Stations.apiKeyJCDECAUX;
	},
	...
	infoLocalStorage : function(nomStation) {
		...
		$('.reservation').click(function() {
			...
			var regex = /^[a-zA-ZáàâäãåçéèêëíìîïñóòôöõúùûüýÿæœÁÀÂÄÃÅÇÉÈÊËÍÌÎÏÑÓÒÔÖÕÚÙÛÜÝŸÆŒ\s-]{3,25}$/;
